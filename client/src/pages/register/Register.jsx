    ...
    const registerUser = async (e) => {
        ...
        try {
            ...
            if (data.error) {
                ...
                setData({})
                toast.success('Registered successful. Welcome!')
                navigate('/login')
            }
        } catch (error) {
  ...
  return (
    <div>
        <form onSubmit={registerUser}>
            ...
            <input type="text" placeholder='enter your password...' value={data.password} onChange={(e) => setData({...data, password: e.target.value}) } />
